...
def train_and_evaluate_model_b(
    ...
    try:
        ...
        if model_env:
            ...
            artifact_dir = Path(__file__).resolve().parent.parent.parent / "artifacts" / "models"
    ...
    save_fairness_report(fairness_report, report_filename, artifact_dir=artifact_dir)
